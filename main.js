...
class UI {
	...
	renderProductos(productos){
		...
		productos.forEach((producto) =>{
          ...
          <div class="bottom">
            <div class="btn__group">
              <button class="btn addToCart" data-id=${producto.id}>Añadir carrito</button>
              <a href="productos-detallados.html?id=${producto.id}" class="btn view">Vista</a>
            </div>
          </div>
        </div>
				`
	...
	//ASIGNO AL BOTON AGREGAR AL CARRITO
	getButtons(){
		...
		buttons.forEach((button)=> {
			...
			button.addEventListener("click", e =>{
				...
				//Agrego el producto al carrito con spread operator
				carrito = [...carrito, carritoItem];

				//GUARDO el carrito al localstorage
